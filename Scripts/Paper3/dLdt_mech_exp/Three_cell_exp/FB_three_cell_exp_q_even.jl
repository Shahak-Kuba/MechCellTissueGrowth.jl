...
ax0 = Axis(f4[1,1:3], xlabel=L"x", title=L"q_{0}(x) = 1,\; k/\eta = 5,\; m = 5")
...
save("FB_three_cell_Lt_even.png", f)
save("FB_three_cell_dLdt_longer_even.png", f2)
save("FB_three_cell_final_cell_length_even.png", f3)
save("FB_three_cell_all_cell_lengths_even.png", f4)