...
for a_value in resting_lengths
    ...
    for m_value in m_vals
        ...
        FB_IC = MCTG.FB_IC_t(q0 = x -> -2x .+ 3.775, q0_der = x -> -2.0, L0 = L0)
...
ax0 = Axis(f4[1,1:3], xlabel=L"x", title=L"q_{0}(x) = -2x+3.775,\; k/\eta = 5,\; m = 5")
...
save("FB_three_cell_final_cell_length_dec.png", f3)
save("FB_three_cell_all_cell_lengths_dec.png", f4)