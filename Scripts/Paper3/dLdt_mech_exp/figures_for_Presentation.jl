...
# figure 1 : Baker et al. vs m = 1
# plotting L(t) for discrete and continuum models
f = Figure(size=(1800, 980));
ax = Axis(f[1,1], xlabel=L"$t$", ylabel=L"$L(t)$", limits=(-1,51,9,51));
...
for ii in 1:1
    scatter!(ax, all_disc_solutions[ii].t[1:100:end], all_disc_solutions_boundary[ii][1:100:end], label=L"N = %$(N_cells*m_vals[ii])", markersize=15, color=clrs[ii], strokecolor=BLACK, strokewidth=0.8);
...
f2 = Figure(size=(1800, 980));
ax = Axis(f2[1,1], xlabel=L"$t$", ylabel=L"$L(t)$", limits=(-1,51,9,51));
L_cont = [sol_Baker.u[i][end] for i in eachindex(sol_Baker.t)]
lines!(ax, sol_Baker.t, L_cont, label=L"\text{Baker et al. 2019}", linewidth=4, color = BLUISH_GREEN);
clrs = [VERMILLION, SKY_BLUE, REDDISH_PURPLE, YELLOW]
for ii in 1:2
...
f3 = Figure(size=(1800, 980));
ax = Axis(f3[1,1], xlabel=L"$t$", ylabel=L"$L(t)$", limits=(-1,51,9,51));
L_cont = [sol_Baker.u[i][end] for i in eachindex(sol_Baker.t)]
lines!(ax, sol_Baker.t, L_cont, label=L"\text{Baker et al. 2019}", linewidth=4, color = BLUISH_GREEN);
clrs = [VERMILLION, SKY_BLUE, REDDISH_PURPLE, YELLOW]
for ii in 1:3
...
f4 = Figure(size=(1800, 980));
ax = Axis(f4[1,1], xlabel=L"$t$", ylabel=L"$L(t)$", limits=(-1,51,9,51));
L_cont = [sol_Baker.u[i][end] for i in eachindex(sol_Baker.t)]
lines!(ax, sol_Baker.t, L_cont, label=L"\text{Baker et al. 2019}", linewidth=4, color = BLUISH_GREEN);
clrs = [VERMILLION, SKY_BLUE, REDDISH_PURPLE, YELLOW]
for ii in 1:4
...
save("Scripts/Paper3/dLdt_mech_exp/Exact_solution/Figures/Presentation/fig_one_m_values.png", f)
save("Scripts/Paper3/dLdt_mech_exp/Exact_solution/Figures/Presentation/fig_two_m_values.png", f2)
save("Scripts/Paper3/dLdt_mech_exp/Exact_solution/Figures/Presentation/fig_three_m_values.png", f3)
save("Scripts/Paper3/dLdt_mech_exp/Exact_solution/Figures/Presentation/fig_four_m_values.png", f4)


f_final = Figure(size=(1800, 980));
ax = Axis(f_final[1,1], xlabel=L"$t$", ylabel=L"$L(t)$", limits=(-1,51,9,51));
L_cont = [sol_Baker.u[i][end] for i in eachindex(sol_Baker.t)]
lines!(ax, sol_Baker.t, L_cont, label=L"\text{Baker et al. 2019}", linewidth=4, color = BLUISH_GREEN);
...
axislegend(ax, position=:rb, framevisible=false, patchsize=(40, 10))
display(f_final)
save("Scripts/Paper3/dLdt_mech_exp/Exact_solution/Figures/Presentation/fig_final.png", f_final)
...
display(f5)
save("Scripts/Paper3/dLdt_mech_exp/Exact_solution/Figures/Presentation/first_term.png", f5)
