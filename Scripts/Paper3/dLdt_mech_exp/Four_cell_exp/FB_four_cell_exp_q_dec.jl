...
for a_value in resting_lengths
    ...
    for m_value in m_vals
        ...
        FB_IC = MCTG.FB_IC_t(q0 = x -> -x .+ 3.1, q0_der = x -> -1.0, L0 = L0)
...
save("FB_three_cell_Lt_longer.png", f)
save("FB_two_cell_dLdt_longer.png", f2)
save("FB_three_cell_final_cell_length.png", f3)
save("FB_three_cell_all_cell_lengths.png", f4)